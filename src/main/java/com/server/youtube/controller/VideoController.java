...
public class VideoController {
    ...
    // 비디오 전체 목록 보기
    @GetMapping("/video")
    public ResponseEntity viewAll(@RequestParam(name="page", defaultValue = "1") int page, (@RequestParam(name="keyword" , required = false)) {
    ...
    // 파일 업로드
        ...
        // http://168.10.51:8082/video/파일
        File videoFile = new File(pathname:path + "video" + File.separator + videoName);
        // http:// 192.168.10.51:8082/thumbnail/파일
        File imageFile = new File(pathname:path + "thumbnail" + File.separator + imageName);
        // 실제 업로드!
